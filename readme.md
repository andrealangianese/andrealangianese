...
* Node.js + Express
* MySQL
* API REST per prodotti e ordini
* Collaborazione tramite Git e GitHub
* Collegamento con Stripe

#### ✈️ LangiaRoad
E-commerce per viaggi all'insegna dell'avventura sviluppato durante il percorso con Boolean.
